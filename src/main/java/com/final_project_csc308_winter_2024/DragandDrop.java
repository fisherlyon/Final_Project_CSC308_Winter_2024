...
//
//
//    public DragandDrop(Disk disk, TowerPanel panel){
//        this.disk = disk;
//        this.panel = panel;
//        initializeCursors();
...
//            panel.setCursor(grabbedHandCursor); // button 1 is left click on mouse
//        }
//
//
//
...
//        dragging = false;
//        panel.setCursor(openHandCursor); // true and false for hand open or close
//    }
//
//    @Override
